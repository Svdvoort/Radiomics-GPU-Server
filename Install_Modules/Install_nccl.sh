...
nccl_version="2.2.13"
nccl_file="/home/svdvoort/Downloads/nccl_2.2.13-1+cuda9.2_x86_64.txz"
...
mkdir -p /etc/modulefiles/nccl
${DIR}/Module_files/create_nccl_module_file.sh "${nccl_version}" "/etc/modulefiles/nccl/${nccl_version}"
